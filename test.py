# test script to perform prediction on test images inside 
# dataset/test/
#   -- image_1.jpg
#   -- image_2.jpg
#   ...
...
print(f"[INFO] train labels: {train_labels}")

# get all the test images paths
test_images = os.listdir(test_path)
print(f"[INFO] test images: {test_images}")
...
for image_path in test_images:
  ...
  # display each image for 1 second before processing the next
    cv2.waitKey(5000)
